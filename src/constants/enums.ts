...
export enum SuccessMessage {
  ...
  HouseholdHandleUpdated = 'Handle updated',
  ...
  OccasionAdded = 'Occasion added',
  OccasionUpdated = 'Occasion updated',
  OccasionRemoved = 'Occasion removed',
  PasswordUpdated = 'Password updated',
  ReminderAdded = 'Reminder added',
  ReminderRemoved = 'Reminder removed',
  ReminderTicked = 'Reminder ticked off',
  ReminderUnticked = 'Reminder put back',
  ...
  FeatureRequestPosted = 'Request posted',
  FeatureRequestDeleted = 'Request deleted',
  FeatureRequestReported = "Thanks. We'll take a look.",
  FeatureRequestAuthorHidden = "You won't see their requests",
  FeatureRequestStatusChanged = 'Status updated',
  FeatureRequestRestored = 'Request restored',
...
export enum ErrorMessage {
  ...
  ReminderRemoveFailed = 'Could not remove the reminder',
  ReminderSaveFailed = 'Could not save the reminder',
  ReminderTickFailed = 'Could not tick off the reminder',
  ReminderUntickFailed = 'Could not put the reminder back',
  ChecklistSaveFailed = 'Could not save the checklist',
  ChecklistDeleteFailed = 'Could not delete the checklist',
  ChecklistResetFailed = 'Could not reset the checklist',
  ChecklistItemSaveFailed = 'Could not save the item',
  ChecklistItemRemoveFailed = 'Could not remove the item',
  ChecklistTickFailed = 'Could not tick the item',
  FeatureRequestPostFailed = 'Could not post your request',
  FeatureRequestVoteFailed = 'Could not save your vote',
  FeatureRequestDeleteFailed = 'Could not delete the request',
  FeatureRequestReportFailed = 'Could not report the request',
  FeatureRequestHideFailed = 'Could not hide their requests',
  FeatureRequestStatusFailed = 'Could not update the status',
  FeatureRequestRestoreFailed = 'Could not restore the request',
  ...
  HouseholdCreateFailed = 'Could not create your household',
  HouseholdDeleteFailed = 'Could not delete the household',
  HouseholdDeleteNotOwner = 'Only an owner can delete a household',
  HouseholdUpdateFailed = 'Could not update the household',
  HouseholdHandleTaken = 'That handle was just taken',
  HouseholdListedFailed = 'Could not change who can find your household',
  ...
  OccasionAddFailed = 'Could not add the occasion',
  OccasionUpdateFailed = 'Could not update the occasion',
  OccasionRemoveFailed = 'Could not remove the occasion',
  ...
  AccountDeleteFailed = 'Your account was not deleted',
  OwnerHandOverFailed = 'Could not set the new Owner',
