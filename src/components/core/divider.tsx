...
// The one horizontal rule. It carries no margin of its own -- spacing belongs to the parent, so
// the same line can sit under a sheet header and above a nested list without either fighting
// it.
